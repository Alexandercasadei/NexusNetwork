...
function createCardElement(s, isLive) {
    ...
    row.innerHTML = `
        ...
        <div class="flex-shrink-0 w-full md:w-auto mt-4 md:mt-0">
            <a href="../player/player.html?user=${s.name}" class="action-btn block w-full md:w-auto text-center px-8 py-3 rounded-xl font-bold transition-all duration-300 transform hover:scale-105 ${isLive ? 'bg-cyan-500 text-black hover:bg-cyan-400 hover:shadow-[0_0_20px_rgba(34,211,238,0.4)]' : 'bg-white/5 text-gray-400 hover:bg-white/10'}">
